...
<div id="flash_sale_pro_creation">
	...
	<div id="flash_sale_pro_configuration">
		...
		<div class="col-sm-12 col-md-12 col-lg-12 tighten-up">
		    ...
		    <div class="col-sm-12 col-md-12 col-lg-12">
				<label for="flash_product_page_right_switch" class="col-sm-12 col-md-3 col-lg-3">
					{l s='Show active Flash Sale on all product page footers :' mod='flashsalepro'}
					<div class="clear">&nbsp;</div>
				</label>
		        <span id="flash_product_page_footer_switch" class="switch prestashop-switch input-group col-sm-12 col-md-3 col-lg-3" style="display:inline-block;">
		            <input type="radio" name="flash_product_page_footer_switch" id="flash_product_page_footer_switch_yes" value="1" {if $flash_product_page_footer_switch eq 1}checked="checked"{/if} />
		            <label for="flash_product_page_footer_switch_yes" class="radioCheck">
		                    <i class="color_success"></i> {l s='Yes' mod='flashsalepro'}
		            </label>
		            <input type="radio" name="flash_product_page_footer_switch" id="flash_product_page_footer_switch_no" value="0" {if $flash_product_page_footer_switch eq 0}checked="checked"{/if} />
		            <label for="flash_product_page_footer_switch_no" class="radioCheck">
		                <i class="color_success"></i> {l s='No' mod='flashsalepro'}
		            </label>
		            <a class="slide-button btn"></a>
		        </span>
