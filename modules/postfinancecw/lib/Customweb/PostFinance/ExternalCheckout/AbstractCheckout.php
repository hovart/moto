 ...
 *
 */
abstract class Customweb_PostFinance_ExternalCheckout_AbstractCheckout extends Customweb_Payment_ExternalCheckout_AbstractCheckout{

	private $container;
	
	public function __construct(Customweb_DependencyInjection_IContainer $container) {
		parent::__construct(new Customweb_PostFinance_Container($container));
	}
