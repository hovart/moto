...
<div id="ukoocompat_search_block_{$search->id|intval}" class="block ukoocompat_search_block col-md-6 col-md-offset-6 col-sm12" style="clear: both;">
...
<script>
    $( document ).ready(function() {
        $('#ukoocompat_search_block_1').prependTo('#ukoo-filters');
    });
</script>