...
/**
 * PostFinanceCw_DiscoverCard 
 * 
 * This class defines is the module class for the 
 * payment method "DiscoverCard".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_DiscoverCard extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_discovercard';
	public $paymentMethodName = 'discovercard';
	public $paymentMethodDisplayName = 'Discover Card';
