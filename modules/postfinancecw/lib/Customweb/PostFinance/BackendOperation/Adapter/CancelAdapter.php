...
require_once 'Customweb/PostFinance/BackendOperation/Adapter/CancelParameterBuilder.php';
 ...
 *
 */
class Customweb_PostFinance_BackendOperation_Adapter_CancelAdapter extends Customweb_PostFinance_AbstractAdapter 
	...
	public function cancel(Customweb_Payment_Authorization_ITransaction $transaction) {
		...
		$builder = new Customweb_PostFinance_BackendOperation_Adapter_CancelParameterBuilder($transaction, $this->getContainer());
