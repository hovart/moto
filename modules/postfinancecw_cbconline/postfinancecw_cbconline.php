...
/**
 * PostFinanceCw_CbcOnline 
 * 
 * This class defines is the module class for the 
 * payment method "CbcOnline".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_CbcOnline extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_cbconline';
	public $paymentMethodName = 'cbconline';
	public $paymentMethodDisplayName = 'CBC Online';
