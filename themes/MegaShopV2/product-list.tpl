...
{if isset($products)}
	...
	{/if} 
			...
			<a href="{$product.link|escape:'htmlall':'UTF-8'}" class="product_img_link" title="{$product.name|escape:'htmlall':'UTF-8'}">
				<img class="img_first" style="display:block;" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html'}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" {if isset($homeSize)} width="100%" height="auto"{/if} />

				{if $product.id_image2 == 0}
					<img class="img_second" style="display:none" src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html'}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" {if isset($homeSize)} width="100%" height="auto"{/if} />
				{else}
					<img class="img_second" style="display:none" src="{$link->getImageLink($product.link_rewrite, $product.id_image2, 'large_default')}" alt="{$product.legend|escape:'htmlall':'UTF-8'}" {if isset($homeSize)} width="100%" height="auto"{/if} />
				{/if} 
			</a>
