 ...
 * @BackendForm
 */
final class Customweb_PostFinance_BackendOperation_Form_StaticTemplate extends Customweb_Payment_BackendOperation_Form_Abstract {
	const STORAGE_SPACE_KEY = 'PostFinance_StaticTemplate';
...
have a secure environment to store your image, contact your PostFinance to store your logo on their server.'),
				'default' => '' 
			) 
		);
	}
