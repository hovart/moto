...
{else}
<div class="wishlist">
	<a class="addToWishlist wishlistProd_{$product.id_product|intval} simptip" href="#" rel="{$product.id_product|intval}" onclick="WishlistCart('wishlist_block_list', 'add', '{$product.id_product|intval}', false, 1); return false;" data-tooltip="{l s='Add to Wishlist' mod='blockwishlist'}"><i class="fa fa-heart"></i></a>
</div>
{/if}