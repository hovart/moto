...
class MGDBOTTOMSERVICECLIENT extends Module
{
	public function __construct()
	{
		$this->name = 'mgdbottomserviceclient';
		$this->description = 'Affichage des coordonnes service client';
		$this->tab = 'front_office_features';
		$this->version = '1.1.1';
		$this->author = 'emotionLoop';
		$this->need_instance = 0;
		$this->ps_versions_compliancy = array('min' => '1.5', 'max' => '1.6');
		$this->monolanguage_content = 'Mgdbottomserviceclient_MONOLANGUAGE';
		$this->text_editor_content = 'Mgdbottomserviceclient_TEXTEDITOR';
		$this->content_wrapper = 'Mgdbottomserviceclient_CONTENTWRAPPER';
		$this->content_wrapper_class = 'Mgdbottomserviceclient_CONTENTWRAPPER_CLASS';
		$this->content_wrapper_id = 'Mgdbottomserviceclient_CONTENTWRAPPER_ID';
		$this->bootstrap = true;
		$this->_html = '';
		...
		$this->displayName = $this->l('mgdBottomServiceclient');
		$this->description = $this->l('Affichage des coordonnes service client');
	...
	public function install()
	{
		...
		if (!parent::install() || !$this->registerHook(array('header', 'TopFooter')) || !$this->registerHook(array('footer', 'TopFooter')) || !MGDBOTTOMSERVICECLIENTModel::createTables())
			return false;
	...
	public function uninstall()
	{
		$this->_clearCache('template.tpl');
		if (!parent::uninstall()
			|| !MGDBOTTOMSERVICECLIENTModel::DropTables())
		{
	...
	public function addFilesToTemplate($path = null)
	{
		...
		$files_data = MGDBOTTOMSERVICECLIENTModel::getFilesInUse( $this->selected_store_id, $this->selected_language_id );
	...
	{
		$content_query = MGDBOTTOMSERVICECLIENTModel::getContent( $this->selected_store_id, $this->selected_language_id );
		$pre_content = '';
		$pos_content = '';
		...
		if (Tools::isSubmit('submit'.$this->name))
		{
				...
				&& (int)Configuration::get('PS_LANG_DEFAULT') == $this->selected_language_id ))
			{
				...
				if (Tools::getValue('content_text') !== false && $this->ignore_changes_content_changes == false)
					MGDBOTTOMSERVICECLIENTModel::setContent( Tools::getValue('content_text'), $this->selected_store_id, $this->selected_language_id );

				//store the files to be used
				if (Tools::getValue('headerFiles') !== false)
					MGDBOTTOMSERVICECLIENTModel::setFiles(
	...
	public function displayForm()
	{
		...
		$helper->fields_value['headerFiles[]'] = $this->processSelectFilesForMultiselect(
																MGDBOTTOMSERVICECLIENTModel::getFilesInUse( $this->selected_store_id, $this->selected_language_id )
																);
...
class MGDBOTTOMSERVICECLIENTModel extends ObjectModel
{

	public static $definition = array(
		'table' => 'mgdbottomserviceclient',
		'primary' => 'file_id',
		'multishop' => true,
		'multilang' => true,
		'fields' => array(
	...
	public static function createTables()
	{
		...
		return ( MGDBOTTOMSERVICECLIENTModel::createFilesTable()
				&& MGDBOTTOMSERVICECLIENTModel::createContentTable());
	}
