...
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/BlogCategory.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/Blogcomment.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/BlogPostCategory.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/BlogTag.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/SmartBlogPost.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/classes/BlogImageType.php');
require_once ('/home/prestashop/www/modules/smartblog' . '/controllers/admin/AdminAboutUsController.php');

class smartblogModule extends Module {
    ...
    public function install(){
            ...
            Configuration::updateGlobalValue('smartacceptcomment', '0');
            Configuration::updateGlobalValue('smartcustomcss', ''); 
            Configuration::updateGlobalValue('smartdisablecatimg','0'); 
            ...
            Configuration::updateGlobalValue('smartblogmetadescrip', 'Prestashop powerfull blog site developing module. It has hundrads of extra plugins. This module developed by SmartDataSoft.com'); 
			$this->addquickaccess();
        $langs = Language::getLanguages();
         if (!parent::install() || !$this->registerHook('displayHeader') || !$this->SmartHookInsert() 
            ...
            return false;
         $sql = array();
        require_once('/home/prestashop/www/modules/smartblog' . '/sql/install.php');
        foreach ($sql as $sq) :
    ...
    public function SmartHookInsert() {
        $hookvalue = array();
        require_once('/home/prestashop/www/modules/smartblog' . '/sql/addhook.php');
    ...
    public function uninstall() {
        ...
        require_once('/home/prestashop/www/modules/smartblog' . '/sql/uninstall_tab.php');
        ...
        endforeach;
                $sql = array();
        require_once('/home/prestashop/www/modules/smartblog' . '/sql/uninstall.php');
        foreach ($sql as $s) :
    ...
    protected function CreateSmartBlogTabs() {
                ...
                $smarttab->save();
                $tab_id = $smarttab->id;
                @copy('/home/prestashop/www/modules/smartblog'."/AdminSmartBlog.gif",_PS_ROOT_DIR_."/img/t/AdminSmartBlog.gif");
                require_once('/home/prestashop/www/modules/smartblog' . '/sql/install_tab.php');
        ...
        $this->fields_form[0]['form'] = array(
          ...
          'title' => $this->l('Setting'),
            ...
            'input' => array(
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Auto accept comments'),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display Author Name'),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display Post Viewed Count'),
                ...
                array(
                    'type' => 'radio',
                    'label' => $this->l('Display Author Name Style'),
                ...
                array(
                    'type' => 'switch',
                    'label' => $this->l('Display Category Info'),
                    'name' => 'smartdisablecatimg',
                    'desc'=>'Show category image and description on blog category page?',
                    'values' => array(
                        array(
    ...
    protected function regenerateform() {
             $default_lang = (int)Configuration::get('PS_LANG_DEFAULT');
                    $this->fields_form[0]['form'] = array(
                            'legend' => array(
                                    'title' => $this->l('Regenerate Blog thumbnails'),
                            ),
                            'input' => array(
                                array(
                                    'type' => 'switch',
         ...
         $languages = Language::getLanguages(false);
                for ($i = 1; $i <= 6; $i++){
                    ...
                    elseif($i==2):
                        ...
                        $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==3):
                        $title='Join Our Fashion Week';
                        $slug='join-our-fashion-week';
                        $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==4):
                        $title='Enjoy Discounts This Season';
                        $slug='enjoy-discounts-this-season';
                        $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==5):
                        $title='Huge Saving Limited Offer';
                        $slug='huge-saving-limited-offer';                        
                        $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.';
                    elseif($i==6):
                        $title='Summer Collection Launched';
                        $slug='summer-collection-launched';                        
                        $des='Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.'; 
                    endif;		 
                    foreach ($languages as $language){
