...
/**
 * PostFinanceCw_AmazonCheckout 
 * 
 * This class defines is the module class for the 
 * payment method "AmazonCheckout".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_AmazonCheckout extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_amazoncheckout';
	public $paymentMethodName = 'amazoncheckout';
	public $paymentMethodDisplayName = 'Amazon Payments';
