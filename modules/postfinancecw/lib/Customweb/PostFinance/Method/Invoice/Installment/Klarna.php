...
require_once 'Customweb/PostFinance/Method/Invoice/LineItemBuilder/Klarna.php';
require_once 'Customweb/Util/String.php';
require_once 'Customweb/PostFinance/Util.php';
require_once 'Customweb/Payment/Authorization/IInvoiceItem.php';
require_once 'Customweb/PostFinance/Method/Invoice/Installment/Abstract.php';
 ...
 */
class Customweb_PostFinance_Method_Invoice_Installment_Klarna extends Customweb_PostFinance_Method_Invoice_Installment_Abstract {
...
public function getSupportedCountries() {
	...
	public function getAuthorizationParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PostFinance_Method_Invoice_LineItemBuilder_Klarna($transaction->getTransactionContext()->getOrderContext());
...
// 		}
	...
	protected function getCuidParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData) {
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
