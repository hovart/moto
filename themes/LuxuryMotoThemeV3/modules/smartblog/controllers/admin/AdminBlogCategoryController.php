          ...
          'title' => $this->l('Blog Category'),
            ...
            'input' => array(
                array(
                    ...
                    'size' => 60,
                    'required' => true,
                    'desc' => $this->l('Enter Category Name'),
                    'lang' => true,
                ),
                array(
                    'type' => 'textarea',
                ...
                array(
                    ...
                    'size' => 60,
                    'required' => false,
                    'desc' => $this->l('Enter Category Meta keyword separated by comma. Eg: meta,keyword,sample')
                ),
                array(
                    'type' => 'textarea',
                ...
                array(
                    ...
                    'lang' => true,
                    'required' => true,
                    'desc' => $this->l('Enter Category Slug. Used in SEO friendly URL')
                ),
                array(
                    'type' => 'select',
