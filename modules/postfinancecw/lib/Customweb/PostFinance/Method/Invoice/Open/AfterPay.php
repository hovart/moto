...
require_once 'Customweb/PostFinance/Method/Invoice/Open/AfterPay/LineItemBuilder.php';
 ...
 */
class Customweb_PostFinance_Method_Invoice_Open_AfterPay extends Customweb_PostFinance_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PostFinance_Method_Invoice_Open_AfterPay_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
	...
	protected function getCompanyParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData) {
		$parameters = array();
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
