 ...
 */
class Customweb_PostFinance_Method_LineItemBuilder_AmazonCheckout extends Customweb_PostFinance_AbstractLineItemBuilder {
	 ...
	 * (non-PHPdoc)
	 * 
	 * @see Customweb_PostFinance_AbstractLineItemBuilder::getLineItemFields()
	 */
