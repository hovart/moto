...
class editorialfooterfbClass extends ObjectModel
{
	/** @var integer editorialfooterfb id */
	public $id;

	/** @var integer editorialfooterfb id shop */
	public $id_shop;
	...
	public static $definition = array(
		'table' => 'editorialfooterfb',
		'primary' => 'id_editorialfooterfb',
		'multilang' => true,
		'fields' => array(
	...
	{
		$id = Db::getInstance()->getValue('SELECT `id_editorialfooterfb` FROM `'._DB_PREFIX_.'editorialfooterfb` WHERE `id_shop` ='.(int)$id_shop);

		return new editorialfooterfbClass($id);
	}
