<?php /* Smarty version Smarty-3.1.19, created on 2017-08-08 10:30:32
         compiled from "/home/prestashop-pp/www/themes/LuxuryMotoThemeV3/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1345787332598976a8e38f58-95815542%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e6a2d776b3ac1d9269f6f638a156757bdbf49093' => 
    array (
      0 => '/home/prestashop-pp/www/themes/LuxuryMotoThemeV3/header.tpl',
      1 => 1461145928,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1345787332598976a8e38f58-95815542',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598976a8ee3548_62765902',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598976a8ee3548_62765902')) {function content_598976a8ee3548_62765902($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/home/prestashop-pp/www/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
"<?php }?> class="mgd <?php if (isset($_smarty_tpl->tpl_vars['page_name']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page_name']->value, ENT_QUOTES, 'UTF-8', true);?>
...
">
	<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>'displayAfterBody'),$_smarty_tpl);?>
...
">
								<img class="logo img-responsive" src="/img/moto-good-deal-logo-<?php if ($_smarty_tpl->tpl_vars['lang_iso']->value=='de') {?>de<?php } else { ?>fr<?php }?>.png" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shop_name']->value, ENT_QUOTES, 'UTF-8', true);?>
...
<?php }?>
			...
			<div id="columns" class="clearfix">
				...
				<?php }?>
					...
					<div id="left_column" class="col-xs-12 col-md-3"><?php echo $_smarty_tpl->tpl_vars['HOOK_LEFT_COLUMN']->value;?>
</div>
					<?php }?>
					<div id="center_column" class="<?php if ($_smarty_tpl->tpl_vars['page_name']->value!='index') {?>col-xs-12<?php }?><?php if (isset($_smarty_tpl->tpl_vars['left_column_size']->value)&&!empty($_smarty_tpl->tpl_vars['left_column_size']->value)) {?> col-md-9<?php }?>">
						<div id="top_column">
