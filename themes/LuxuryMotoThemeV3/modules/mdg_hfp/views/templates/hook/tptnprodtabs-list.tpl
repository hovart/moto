...
{if isset($product.reduction) && $product.reduction}<span class="sale-box">
	...
	<div class="right-block">
		<div class="manufacturerContainer">
					<img class="manufacturer" src="{$img_manu_dir}{$product.id_manufacturer}.jpg" alt="{$product.manufacturer_name|escape:'htmlall':'UTF-8'}" title="{$product.manufacturer_name|escape:'htmlall':'UTF-8'}" />
				</div>
		<h5 itemprop="name">
