            ...
            <form action="{$link->getPageLink('index',true)|escape:'html'}" method="post">
               ...
               <!-- {if $page_name != 'index'}                
                ...
                {/if}-->
                    ...
                    <div id="nl-txt">
                    <p style="padding:0 5px 10px 5px;"><img src="{$img_ps_dir}/admin/gold.gif"/> {l s='Inscrivez-vous à la newsletter et recevez un bon de réduction de 5CHF à partir de 100CHF' mod='blocknewsletter'}</p></div>
                {/if}
                <!-- offre inscription newsletter-->
