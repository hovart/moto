...
class StoreCommander extends Module
{
    ...
    public function getContent()
    {
        ...
        $_html = '';
        $_html .= '<link type="text/css" rel="stylesheet" href="../modules/' . $this->name . '/views/css/admin.css" />' . "\n";
        $_html .= '<script type="text/javascript" src="../modules/' . $this->name . '/views/js/loader/jquery.loader-min.js"></script>
