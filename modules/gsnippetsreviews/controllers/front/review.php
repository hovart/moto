<?php
/**
 * review.php file defines review front controller
 *
 * @author    Business Tech SARL <http://www.businesstech.fr/en/contact-us>
 * @copyright 2003-2015 Business Tech SARL
 */

class GSnippetsReviewsReviewModuleFrontController extends ModuleFrontController
{
	/**
	...
	public function initContent()
	{
		...
		$oHook = new BT_GsrHookCtrl('display', 'review');
