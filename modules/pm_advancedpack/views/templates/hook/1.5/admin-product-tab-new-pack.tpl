	...
	<div class="form-group clearfix">
		<div class="col-lg-7">
			...
			<div id="ap5_price_rules_3_configuration" class="ap5-admin-hide hide">
				<label class="control-label col-lg-4" for="ap5_fixed_pack_price">
					<span class="label-tooltip" data-toggle="tooltip" title="{l s='Enter a fixed amount for your pack' mod='pm_advancedpack'}">
						{l s='Pack price' mod='pm_advancedpack'}
						<em class="ap5-fixed-pack-price-without-taxes{if $idTaxRulesGroup <= 0} ap5-admin-hide hide{/if}"> {l s='(without taxes)' mod='pm_advancedpack'}</em>
						<em class="ap5-fixed-pack-price-with-taxes{if $idTaxRulesGroup !== 0 || is_null($idTaxRulesGroup)} ap5-admin-hide hide{/if}"> {l s='(with taxes)' mod='pm_advancedpack'}</em>
					</span>
				</label>
				<div class="col-lg-4">
					<div class="input-group">
						<input min="0" type="text" onchange="this.value = this.value.replace(/,/g, '.');" value="{$packFixedPrice|floatval}" id="ap5_fixed_pack_price" name="ap5_fixed_pack_price" maxlength="14" />
			...
			<div id="ap5_price_rules_4_configuration" class="ap5-admin-hide hide">
				<label class="control-label col-lg-4" for="ap5_allow_remove_product">
					<span class="label-tooltip" data-toggle="tooltip" title="{l s='Check this box if you want your customers to be able to remove a product from the pack. This option can only be enabled if you have more than 2 products into your pack and if inherit discounts option is enabled on each product.' mod='pm_advancedpack'}">
		...
		<table id="ap5-pack-content-table" class="table configuration">
			<thead>
				<tr class="nodrag nodrop">
					...
					<th class="center"><span class="label-tooltip" data-toggle="tooltip" title="{l s='If you want to only use specific combinations, check this box' mod='pm_advancedpack'}">{l s='Custom' mod='pm_advancedpack'}</span></th>
