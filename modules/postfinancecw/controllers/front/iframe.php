...
class PostFinanceCwIframeModuleFrontController extends ModuleFrontController
{
	public $ssl = true;
	...
	public function initContent()
	{
		...
		if (!($wrapper instanceof PostFinanceCw_Adapter_IframeAdapter)) {
			throw new Exception("Expect 'PostFinanceCw_Adapter_IframeAdapter'.");
		}
