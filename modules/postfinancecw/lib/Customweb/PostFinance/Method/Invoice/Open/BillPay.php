...
require_once 'Customweb/PostFinance/Method/Invoice/Open/BillPay/LineItemBuilder.php';
 ...
 */
class Customweb_PostFinance_Method_Invoice_Open_BillPay extends Customweb_PostFinance_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PostFinance_Method_Invoice_Open_BillPay_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
