...
abstract class Customweb_PostFinance_ExternalCheckout_MasterPass_AbstractRequestParameterBuilder {
	...
	public function __construct(Customweb_Payment_ExternalCheckout_IContext $context, Customweb_PostFinance_Container $container) {
	...
	/**
	 * @return Customweb_PostFinance_Container
	 */
