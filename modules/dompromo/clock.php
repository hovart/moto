...
<span style="color:green; vertical-align: top;font-weight:bold;" id="ClockTime" onclick="clockToggleSeconds()"><?php echo(clockTimeString($gDate,$gClockShowsSeconds));?></span>&nbsp;&nbsp;
<span style="color:green; vertical-align: top;font-weight:bold;" id="ClockBkgnd"><?php echo(clockDateString($gDate));?> </span>
