...
{if $totSplashScreen}
     ...
     <div id="totsplashscreen" style="width:{$totSplashScreen.totsplashscreen_width}px; height:{$totSplashScreen.totsplashscreen_height}px;background-color:{$totSplashScreen.totsplashscreen_backgroundColor}">
