...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Upload New Reception List' mod='tmmegamenu'}
    </h3>
    <form enctype = "multipart/form-data" method="post" action="{$base_url}override/modules/tmmegamenu/ajax.php">
 
  <div class="form-group">
    <label >Choose csv file</label>
    <input type="file" name="csv" >
  </div>
 <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />
<input type="hidden" name="method" value="uploadReceptionCsv"> 
  <button type="submit" class="btn btn-primary">Upload</button>
</form>
   
    {if isset($smarty.get.ReceptionCsvUploadMessage) } 
    {if $smarty.get.ReceptionCsvUploadMessage == "Success"}
    <div class="alert alert-success">{$smarty.get.ReceptionCsvUploadMessage}</div>
    {else}
    <div class="alert alert-danger">{$smarty.get.ReceptionCsvUploadMessage}</div>
    {/if} 
    {/if} 
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Upload New Category List' mod='tmmegamenu'}
    </h3>
    <form enctype = "multipart/form-data" method="post" action="{$base_url}override/modules/tmmegamenu/ajax.php">
 ...
 <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />
<input type="hidden" name="method" value="uploadCategoryCsv"> 
  <button type="submit" class="btn btn-primary">Upload</button>
</form>
   
    {if isset($smarty.get.CategoryCsvUploadMessage) } 
    {if $smarty.get.CategoryCsvUploadMessage == "Success"}
    <div class="alert alert-success">{$smarty.get.CategoryCsvUploadMessage}</div>
    {else}
    <div class="alert alert-danger">{$smarty.get.CategoryCsvUploadMessage}</div>
    {/if} 
    {/if} 
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Upload New Articles List' mod='tmmegamenu'}
    </h3>
    <form enctype = "multipart/form-data" method="post" action="{$base_url}override/modules/tmmegamenu/ajax.php">
 ...
 <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />
<input type="hidden" name="method" value="uploadArticlesCsv"> 
  <button type="submit" class="btn btn-primary">Upload</button>
</form>
   
    {if isset($smarty.get.ArticleCsvUploadMessage) } 
    {if $smarty.get.ArticleCsvUploadMessage == "Success"}
    <div class="alert alert-success">{$smarty.get.ArticleCsvUploadMessage}</div>
    {else}
    <div class="alert alert-danger">{$smarty.get.ArticleCsvUploadMessage}</div>
    {/if} 
    {/if} 
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Category list' mod='tmmegamenu'}
        
        <span class="panel-heading-action">
        <a class="list-toolbar-btn" style="cursor:pointer;" >
            <span class="label-tooltip" data-placement="top" data-toggle="modal" data-target="#AddNewCategory" data-html="true" data-original-title="Add new" data-toggle="tooltip" title="">
                                          ...
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Add new Category</h4>
                                                  ...
                                                  <form  method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                        
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Category Id :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="category_id" ><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Category German :</label>
                                                        <input type="text" min="0" style="width:70%;margin-top:20px; " name="category_german" ><br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:25px;">Category French:</label>
                                                        <input type="text" style="width:70%;margin-top:15px; " name="category_french" >
                                                        <input type="hidden" name="method" value="addCategory"> 
                                                      <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                           <button class=" btn btn-primary btn-lg Add_New_category"  type="submit" data_base_url="{$base_url}">Save</button>
                                                    </form>
        ...
        <div class="table-responsive-row clearfix">
            <table class="table">
                <thead>
                    <tr>
                        <th>{l s='ID' mod='tmmegamenu'}</th>
                        <th>{l s='Category Id' mod='tmmegamenu'}</th>
                        <th>{l s='Category German' mod='tmmegamenu'}</th>
                        <th>{l s='Category France' mod='tmmegamenu'}</th>
                ...
                <tbody id="list-1">
                   {foreach from=$categories item=category}
                        <tr>
                            ...
                            <td>{$category['category_german']}</td>
                            <td>{$category['category_french']}</td>
                            <td>
                                <div class="btn-group-action">
                                    <div class="btn-group pull-right">
                                          <label  data_id="{$category['id']}"   data-toggle="modal" data-target="#editCategory{$category['id']}" data_base_url="{$base_url}"  class=" btn btn-primary  tmmegamenu_category_edit"  ><i  class="icon-pencil"></i> </label>     
                                        <label  data_id="{$category['id']}"   data-toggle="modal" data-target="#deleteCategory{$category['id']}" data_base_url="{$base_url}"  class="Delete btn btn-danger tmmegamenu_category_delete "  ><i  class="icon-trash "></i> </label>    
                                    ...
                                    <div class="modal-dialog">
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header" style="text-align: center;">
                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                          <h4>Are you sure?</h4>
                                          <button  data_id="{$category['id']}"  data-dismiss="modal" class="btn btn-success btn-lg  Category_delete "  type="submit" data_base_url="{$base_url}">Yes</button>
                                        ...
                                        <div class="modal fade" id="editCategory{$category['id']}" role="dialog">
                         <div class="modal-dialog">
                                          <!-- Modal content-->
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Edit Category</h4>
                                                  ...
                                                  <form  method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                        ...
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Category Id :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="category_id" value="{$category['category_id']}" ><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Category German :</label>
                                                        <input type="text" min="0" style="width:70%;margin-top:20px; " name="category_german" value="{$category['category_german']}"><br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:25px;">Category French:</label>
                                                        <input type="text" style="width:70%;margin-top:15px; " name="category_french" 
                                                               value="{$category['category_french']}">
                                                    
                                                        <input type="hidden" name="method" value="editCategory"> 
                                                        <input type="hidden" name="id" value="{$category['id']}"> 
                                                        <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                           <button class=" btn btn-primary btn-lg Add_New_category"  type="submit" data_base_url="{$base_url}">Edit</button>
                                                    </form>
                                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                                        </div>
                                        </div>
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Articles list' mod='tmmegamenu'}
        
        <span class="panel-heading-action">
        <a class="list-toolbar-btn" style="cursor:pointer;" >
            <span class="label-tooltip" data-placement="top" data-toggle="modal" data-target="#AddNewArticle" data-html="true" data-original-title="Add new" data-toggle="tooltip" title="">
                <i class="process-icon-new"></i>
            </span>
        </a>
        </span>
                    ...
                    <div class="modal fade" id="AddNewArticle" role="dialog">
                         <div class="modal-dialog">
                                          <!-- Modal content-->
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Add new Article</h4>
                                                        ...
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Aricle :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="article"  ><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Reception :</label>
                                                        <input type="text" min="0" style="width:70%;margin-top:20px; " name="reception"><br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:25px;">Category :</label>
                                                        <input type="text" style="width:70%;margin-top:15px; " name="category">                       <input type="hidden" name="method" value="addArticle"> 
                                                        <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                        <button class=" tmmegamenu_brandes_delete btn btn-primary btn-lg save_New_Article"  type="submit" data_base_url="{$base_url}">Save</button>
                                                    </form>
                                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                                        </div>
                                        </div>
        ...
        <div class="table-responsive-row clearfix">
            <table class="table">
                <thead>
                    <tr>
                        <th>{l s='ID' mod='tmmegamenu'}</th>
                        <th>{l s='Articles' mod='tmmegamenu'}</th>
                        <th>{l s='Reception' mod='tmmegamenu'}</th>
                        <th>{l s='Category' mod='tmmegamenu'}</th>
                ...
                <tbody id="list-1">
                   {foreach from=$articles item=article}
                        <tr>
                            ...
                            <td>{$article['reception_type']}</td>
                            <td>{$article['category']}</td>
                            <td>
                                <div class="btn-group-action">
                                    <div class="btn-group pull-right">
                                          <label  data_id="{$article['id']}"   data-toggle="modal" data-target="#editArticle{$article['id']}" data_base_url="{$base_url}"  class=" btn btn-primary  tmmegamenu_article_edit"  ><i  class="icon-pencil"></i> </label>     
                                        <label  data_id="{$article['id']}"   data-toggle="modal" data-target="#deleteArticle{$article['id']}" data_base_url="{$base_url}"  class="Delete btn btn-danger tmmegamenu_article_delete "  ><i  class="icon-trash "></i> </label>    
                                    ...
                                    <div class="modal-dialog">
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header" style="text-align: center;">
                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                          <h4>Are you sure?</h4>
                                          <button  data_id="{$article['id']}"  data-dismiss="modal" class="btn btn-success btn-lg  Article_delete "  type="submit" data_base_url="{$base_url}">Yes</button>
                                        ...
                                        <div class="modal fade" id="editArticle{$article['id']}" role="dialog">
                         <div class="modal-dialog">
                                          <!-- Modal content-->
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Edit Article</h4>
                                                  ...
                                                  <form  method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                        ...
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Aricle :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="article" value="{$article['article_number']}" ><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Reception :</label>
                                                        <input type="text" min="0" style="width:70%;margin-top:20px; " name="reception" value="{$article['reception_type']}"><br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:25px;">Category :</label>
                                                        <input type="text" style="width:70%;margin-top:15px; " name="category" 
                                                               value="{$article['category']}">
                                                    
                                                        <input type="hidden" name="method" value="editArticle"> 
                                                        <input type="hidden" name="id" value="{$article['id']}"> 
                                                        <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                           <button class=" btn btn-primary btn-lg Add_New_article"  type="submit" data_base_url="{$base_url}">Edit</button>
                                                    </form>
                                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                                        </div>
                                        </div>
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Marks list' mod='tmmegamenu'}
        
        <span class="panel-heading-action">
        <a class="list-toolbar-btn" style="cursor:pointer;" >
            <span class="label-tooltip" data-placement="top" data-toggle="modal" data-target="#AddNewMark" data-html="true" data-original-title="Add new" data-toggle="tooltip" title="">
                <i class="process-icon-new"></i>
            </span>
        </a>
        </span>
                    ...
                    <div class="modal fade" id="AddNewMark" role="dialog">
                                    <div class="modal-dialog">
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <h4 class="modal-title">Add new Mark</h4>
                                              ...
                                              <form class="add_New_Mark_Form" method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                  <label style="float:left; margin-left:2%;  margin-right:2%">Mark Name :</label>
                                              <input type="text" style="width:50%; margin-top:20px;" name="markmame"><br>
                                              <label style=" margin-left:2%; margin-right:7%">Status :</label>
                                              
                                                <input type="checkbox" title="active" name="status"> 
                                                <input type="hidden" name="method" value="addNewMark"> 
                                                <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />
                                                    
                                              
                                         
                                        <div class="modal-footer">
                                            <button class=" tmmegamenu_brandes_delete btn btn-primary btn-lg save_New_Mark"  type="submit" data_base_url="{$base_url}">Save</button>
                                            </form>
                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                        </div>
                                      </div>
        ...
        <div class="table-responsive-row clearfix">
            <table class="table">
                <thead>
                    <tr>
                        <th>{l s='ID' mod='tmmegamenu'}</th>
                        <th>{l s='Brand' mod='tmmegamenu'}</th>
                ...
                <tbody id="list-1">
                   {foreach from=$brands item=brand}
                        <tr>
                            <td>{$brand['id']}</td>
                            <td> 
                                <label class="tmmegamenu_search_brande_name">{$brand['brand']} </label>
                                <div class="row " style="display:none;" >
                                <input value="{$brand['brand']}"  type="text" data_id="{$brand['id']}" style="width:20%;float:left;">
                                    <button style="width:5%"  data_base_url="{$base_url}" class="btn btn-success tmmegamenu_search_brande_name_update_button ">Save</button>
                                </div>
                            </td>
                            <td> 
                                <label class="checkbox-inline">
                                  <input type="checkbox" data_base_url="{$base_url}" style="visibility:hidden;" class="tmmegamenu_displayed_checkbox" data-onstyle="success"  data-offstyle="danger" data_id="{$brand['id']}" {if $brand['status'] eq '1'} checked{/if} data-toggle="toggle"> 
                                </label>
                            </td>
                            ...
                            <td>
                                <div class="btn-group-action">
                                    <div class="btn-group pull-right">
                                        <label  data_id="{$brand['id']}"   data-toggle="modal" data-target="#deleteMark{$brand['id']}" data_base_url="{$base_url}"  class="Delete btn btn-danger  tmmegamenu_brandes_delete"  ><i  class="icon-trash"></i> </label>
                                        
                               </div>
                            <div class="modal fade" id="deleteMark{$brand['id']}" role="dialog">
                                    <div class="modal-dialog">
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header" style="text-align: center;">
                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                          <h4>Are you sure?</h4>
                                          <button  data_id="{$brand['id']}"  data-dismiss="modal" class="btn btn-success btn-lg  mark_delete "  type="submit" data_base_url="{$base_url}">Yes</button>
...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Reception list' mod='tmmegamenu'}
        
        <span class="panel-heading-action">
        <a class="list-toolbar-btn" style="cursor:pointer;" >
            <span class="label-tooltip" data-placement="top" data-toggle="modal" data-target="#AddNewReception" data-html="true" data-original-title="Add new" data-toggle="tooltip" title="">
                <i class="process-icon-new"></i>
            </span>
        </a>
        </span>
                    ...
                    <div class="modal fade" id="AddNewReception" role="dialog">
                         <div class="modal-dialog">
                                          <!-- Modal content-->
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              <button type="button" class="close" data-dismiss="modal">&times;</button>
                                              <h4 class="modal-title">Add new Reception</h4>
                                            </div>

                                                  <form class="add_New_Mark_Form" method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                        <label style="width:20%;float:left; margin-left:10px; ">Mark  :</label>
                                                        <select name ="mark"  style="width:70%;margin-top:20px;">
                                                          {foreach from=$allBrands item=brand}
                                                          <option value="{$brand['brand']}">{$brand['brand']}</option>
                                                             {/foreach}
                                                        </select><br>
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:20px; ">Model :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="model"><br> 
                                                          <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Cylinder :</label><br>
                                                        <input type="number" min="0" style="width:70%; " name="cylinder"><br>  <br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:20px;">Construction Year :</label>
                                                        <input type="date" style="width:70%;margin-top:15px; " name="year"><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:20px; ">Reception by type :   </label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="reception"><br> 
                                                        <input type="hidden" name="method" value="AddNewReception"> 
                                                        <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                           <button class=" btn btn-primary btn-lg Add_New_Mark"  type="submit" data_base_url="{$base_url}">ADD</button>
                                                    </form>
                                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                                        </div>
                                        </div>
        ...
        <div class="table-responsive-row clearfix">
            <table class="table">
                <thead>
                    <tr>
                        <th>{l s='ID' mod='tmmegamenu'}</th>
                        <th>{l s='Mark' mod='tmmegamenu'}</th>
                        <th>{l s='Model' mod='tmmegamenu'}</th>
                        <th>{l s='Cylinder' mod='tmmegamenu'}</th>
                        <th>{l s='Construction year' mod='tmmegamenu'}</th>
                        <th>{l s='Reception type' mod='tmmegamenu'}</th>
                        <th></th>
                    </tr>
                </thead>
                <tbody id="list-1">
                   {foreach from=$receptions item=reception}
                        <tr>
                            <td>{$reception['id']}</td>
                            <td>{$reception['mark']}</td>
                            <td>{$reception['model']}</td>
                            <td>{$reception['cylinder']}</td>
                            <td>{$reception['construction_year']}</td>
                            <td>{$reception['reception_type']}</td>
<!--
                         
-->                            <td>
                                <div class="btn-group-action">
                                    <div class="btn-group pull-right">
                                          <label  data_id="{$reception['id']}"   data-toggle="modal" data-target="#editReception{$reception['id']}" data_base_url="{$base_url}"  class=" btn btn-primary  tmmegamenu_reception_edit"  ><i  class="icon-pencil"></i> </label>     
                                        <label  data_id="{$reception['id']}"   data-toggle="modal" data-target="#deleteReception{$reception['id']}" data_base_url="{$base_url}"  class="Delete btn btn-danger tmmegamenu_reception_delete "  ><i  class="icon-trash "></i> </label>    
                                                                 
                               </div>
                                     <div class="modal fade" id="deleteReception{$reception['id']}" role="dialog">
                                    <div class="modal-dialog">
                                      ...
                                      <div class="modal-content">
                                        <div class="modal-header" style="text-align: center;">
                                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                                          <h4>Are you sure?</h4>
                                          <button  data_id="{$reception['id']}"  data-dismiss="modal" class="btn btn-success btn-lg  reception_delete "  type="submit" data_base_url="{$base_url}">Yes</button>
                                        ...
                                        <div class="modal fade" id="editReception{$reception['id']}" role="dialog">
                         <div class="modal-dialog">
                                          <!-- Modal content-->
                                          <div class="modal-content">
                                            <div class="modal-header">
                                              ...
                                              <h4 class="modal-title">Edit Reception</h4>
                                                  ...
                                                  <form  method="get" action="{$base_url}override/modules/tmmegamenu/ajax.php">
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:8px; ">Mark  :</label>
                                                        <select name ="mark"  style="width:70%;margin-top:20px;">
                                                          {foreach from=$allBrands item=brand}
                                                          <option value="{$brand['brand']}">{$brand['brand']}</option>
                                                             {/foreach}
                                                        </select><br>
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Model :</label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="model" value="{$reception['model']}" ><br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px; ">Cylinder :</label>
                                                        <input type="number" min="0" style="width:70%;margin-top:20px; " name="cylinder" value="{$reception['cylinder']}"><br>  
                                                        <label style="width:20%;float:left; margin-left:10px; margin-top:25px;">Construction Year :</label>
                                                        <input type="date" style="width:70%;margin-top:15px; " name="year" 
                                                               value="{date_format(date_create($reception['construction_year']),'Y-m-d')}">
                                                      <br> 
                                                        <label style="width:20%;float:left; margin-left:10px;margin-top:25px;">Reception by type :   </label>
                                                        <input type="text" style="width:70%;margin-top:20px; " name="reception" value="{$reception['reception_type']}"><br> 
                                                        <input type="hidden" name="method" value="editReception"> 
                                                        <input type="hidden" name="id" value="{$reception['id']}"> 
                                                        <input type="hidden" class="hidden" name="back" value="{$base_url}{$smarty.server.REQUEST_URI}" />                                       
                                                        <div class="modal-footer">
                                                           <button class=" btn btn-primary btn-lg Add_New_Mark"  type="submit" data_base_url="{$base_url}">Edit</button>
                                                    </form>
                                                            <button type="button" class="btn btn-danger btn-lg" data-dismiss="modal">Close</button>
                                                        </div>
                                        </div>
