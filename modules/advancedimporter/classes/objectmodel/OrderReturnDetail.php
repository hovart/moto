...
class OrderReturnDetail extends ObjectModel
{
    /** @var int Id order detail*/
    public $id_order_detail;

    /** @var int Id order return */
    public $id_order_return;

    /** @var int Id customization */
    public $id_customization;

    /** @varinteger Product quantity */
    public $product_quantity;

    public $table = 'order_return_detail';
    ...
    public static $definition = array(
        'fields' => array(
            ...
            'id_order_return' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt', 'required' => true),
            'id_customization' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt', 'required' => true),
        ),
    );
