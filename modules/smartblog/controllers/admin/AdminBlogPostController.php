...
class AdminBlogPostController extends AdminController {
    ...
    public function renderForm() 
     {
      $img_desc = '';
        $img_desc .= $this->l('Only JPG image is allowed');
          ...
          'title' => $this->l('Blog Post'),
            ...
            'input' => array(
                ...
                array(
                    ...
                    'size' => 60,
                    'required' => false,
                    'desc' => $this->l('Enter Meta keyword separated by comma. Eg: meta,keyword,sample')
                ),
                array(
                    'type' => 'textarea',
                ...
                array(
                    ...
                    'lang' => true,
                    'required' => false,
                    'desc' => $this->l('Enter Post Slug. Used in SEO Friendly URL')
                ),
                array(
                    'type' => 'text',
                    'label' => $this->l('Tags'),
                    ...
                    'lang' => true,
                    'required' => false,
                    'desc' => $this->l('Enter Post tags separated by comma. Eg: tag,keyword,sample')
                ),
                array(
                    'type' => 'switch',
