...
class MegaMenuOverride extends MegaMenu
{
	public $id_item;
	public $id_parent;
	public $id_shop;
	...
	public static $definition = array(
		...
		'fields'		=>	array(
			...
			'unique_code'	=>	array('type' => self::TYPE_STRING, 'validate' => 'isGenericName', 'required' => true, 'size' => 128),
		),
	);
	...
	*****/
	...
	public function customGetNestedCategories($shop_id, $root_category = null,
											$id_lang = false, $active = true, $groups = null,
											$use_shop_restriction = true, $sql_filter = '',
											$sql_sort = '', $sql_limit = '')
	{
	...
	******/
	public function addMenuItem($id_tab, $ajaxdata = false)
	{
		...
		else if (Tools::getValue('addnewmega') || $ajaxdata)
		{
