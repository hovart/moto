...
{if !empty($bDisplayForm)}
	<div id="comment-form">
		<form method="post" id="bt_report-form" name="bt_report-form" onsubmit="oGsr.form('bt_report-form', '{$sMODULE_URI|escape:'htmlall':'UTF-8'}', '', 'bt_report-form', 'bt_report-form', false, false, null, 'report', 'report');return false;">
			...
			<h3 class="title_block">{l s='Report an abuse' mod='gsnippetsreviews'}</h3>
			...
			<div class="page-product-box">
				...
				<h3 class="page-product-heading">{l s='Your reason' mod='gsnippetsreviews'}</h3>
			...
			<p align="center" class="report-button-margin">
				<button name="bt_comment-button" class="btn btn-success btn-lg" value="{l s='Report' mod='gsnippetsreviews'}"  onclick="oGsr.form('bt_report-form', '{$sMODULE_URI|escape:'htmlall':'UTF-8'}', '', 'bt_report-form', 'bt_report-form', false, false, null, 'report', 'report');return false;" >{l s='Report' mod='gsnippetsreviews'}</button>
				<button class="btn btn-danger btn-lg" value="{l s='Cancel' mod='gsnippetsreviews'}"  onclick="$.fancybox.close();return false;" >{l s='Cancel' mod='gsnippetsreviews'}</button>
			</p>
		</form>
	</div>
