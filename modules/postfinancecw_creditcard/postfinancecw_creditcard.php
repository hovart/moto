...
{
	public $name = 'postfinancecw_creditcard';
 			...
 			2 => array(
				'name' => 'CREDIT_CARD_BRANDS',
 				...
 				'desc' => $this->l("In case hidden authorization is used, the brand of the
						...
						allowed brands.
					"),
 				'default' => 'visa,mastercard,americanexpress,diners,discovercard,jcb,maestrouk,cartebleu,solo',
 				'multiple' => 'true',
 				'type' => 'select',
 				'options' => array(
					'query' => array(
	...
	public function installMethodSpecificConfigurations() {
		...
		$this->getConfigApi()->updateConfigurationValue('CREDIT_CARD_BRANDS', 'visa,mastercard,americanexpress,diners,discovercard,jcb,maestrouk,cartebleu,solo');
