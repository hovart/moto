			...
			this.defaults = {
				feeds: {
					facebook: {
						...
						url: '/themes/MegaShopV2/damienudry/facebook.php',
						icon: 'facebook.png'
					},
					twitter: {
						id: '',
...
/*
* Modification du lien du logo facebook 
*/
		function fbHrefLink(id,obj){
					$('.icon',obj).each(function(){
						$(this).parent().attr('href','https://www.facebook.com/damienudryofficiel');
					});
					$('.section-user a',obj).each(function(){
						$(this).attr('href','https://www.facebook.com/damienudryofficiel');
						$(this).text('Damien Udry');
					});
/*			jQuery.ajax({
