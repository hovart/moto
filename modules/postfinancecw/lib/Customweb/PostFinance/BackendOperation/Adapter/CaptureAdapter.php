...
require_once 'Customweb/PostFinance/BackendOperation/Adapter/CapturingParameterBuilder.php';
 ...
 *
 */
class Customweb_PostFinance_BackendOperation_Adapter_CaptureAdapter extends Customweb_PostFinance_AbstractAdapter 
	...
	public function capture(Customweb_Payment_Authorization_ITransaction $transaction){
		/* @var $transaction Customweb_PostFinance_Authorization_Transaction */
	...
	public function partialCapture(Customweb_Payment_Authorization_ITransaction $transaction, $items, $close){
		...
		$builder = new Customweb_PostFinance_BackendOperation_Adapter_CapturingParameterBuilder($transaction, $this->getContainer(), $amount, $close);
