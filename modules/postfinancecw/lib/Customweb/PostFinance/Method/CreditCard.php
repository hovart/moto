 ...
 */
class Customweb_PostFinance_Method_CreditCard extends Customweb_PostFinance_Method_DefaultMethod {
	...
	private function getErrorCode(Customweb_PostFinance_Authorization_Transaction $failedTransaction) {
