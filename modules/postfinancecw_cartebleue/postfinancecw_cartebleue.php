...
/**
 * PostFinanceCw_CarteBleue 
 * 
 * This class defines is the module class for the 
 * payment method "CarteBleue".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_CarteBleue extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_cartebleue';
	public $paymentMethodName = 'cartebleue';
	public $paymentMethodDisplayName = 'Carte Bleue';
