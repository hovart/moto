...
require_once 'Customweb/PostFinance/Method/Invoice/Open/PostFinanceFis/LineItemBuilder.php';
 ...
 */
class Customweb_PostFinance_Method_Invoice_Open_PostFinanceFis extends Customweb_PostFinance_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PostFinance_Method_Invoice_Open_PostFinanceFis_LineItemBuilder($transaction->getTransactionContext()->getOrderContext());
...
// 			$parameters['OWNERTELNO'] = Customweb_PostFinance_Util::substrUtf8($phoneNumber, 0, 30);
		}
