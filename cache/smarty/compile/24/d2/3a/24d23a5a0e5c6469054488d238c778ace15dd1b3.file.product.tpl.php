<?php /* Smarty version Smarty-3.1.19, created on 2017-08-08 10:30:32
         compiled from "/home/prestashop-pp/www/themes/LuxuryMotoThemeV3/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2017747506598976a880cc67-86861221%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '24d23a5a0e5c6469054488d238c778ace15dd1b3' => 
    array (
      0 => '/home/prestashop-pp/www/themes/LuxuryMotoThemeV3/product.tpl',
      1 => 1497438777,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2017747506598976a880cc67-86861221',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598976a8d90b55_97180232',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598976a8d90b55_97180232')) {function content_598976a8d90b55_97180232($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/prestashop-pp/www/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/prestashop-pp/www/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_counter')) include '/home/prestashop-pp/www/tools/smarty/plugins/function.counter.php';
?>
...
" />
		...
		<div class="pb-left-column">
			...
			<div id="image-block">
				...
				<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale||($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction']&&$_smarty_tpl->tpl_vars['productPriceWithoutReduction']->value>$_smarty_tpl->tpl_vars['productPrice']->value)) {?><span class="sale-box">
...
" data-id="resetImages">
		...
		<div class="pb-right-column">
			<div class="mgd-product-essential">
				<h1 class="page-heading" itemprop="name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
					...
					<a href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['product']->value->id_manufacturer,$_smarty_tpl->tpl_vars['product']->value->link_rewrite), ENT_QUOTES, 'UTF-8', true);?>
"  class="manufacturerProduct" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true);?>
">
						<img src="<?php echo $_smarty_tpl->tpl_vars['base_dir_ssl']->value;?>
img/m/<?php echo $_smarty_tpl->tpl_vars['product_manufacturer']->value->id;?>
.jpg" alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->manufacturer_name, ENT_QUOTES, 'UTF-8', true);?>
"/>
					</a>
					<?php }?>
...
" id="product_page_product_id" />
 ...
 <b id="minimal_quantity_label"><?php echo $_smarty_tpl->tpl_vars['product']->value->minimal_quantity;?>
							...
							<p id="quantity_wanted_p" class="product_p"<?php if ((!$_smarty_tpl->tpl_vars['allow_oosp']->value&&$_smarty_tpl->tpl_vars['product']->value->quantity<=0)||!$_smarty_tpl->tpl_vars['product']->value->available_for_order||$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> style="display: none;"<?php }?>>
								<label for="quantity_wanted" class="attribute_label mtop"><?php echo smartyTranslate(array('s'=>'Quantity'),$_smarty_tpl);?>
 :</label>
...
?>
										<?php if (count($_smarty_tpl->tpl_vars['group']->value['attributes'])) {?>
											<fieldset class="attribute_fieldset">
												<label class="attribute_label mtop" <?php if ($_smarty_tpl->tpl_vars['group']->value['group_type']!='color'&&$_smarty_tpl->tpl_vars['group']->value['group_type']!='radio') {?>for="group_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute_group']->value);?>
...
</span><?php if ($_smarty_tpl->tpl_vars['tax_enabled']->value&&((isset($_smarty_tpl->tpl_vars['display_tax_label']->value)&&$_smarty_tpl->tpl_vars['display_tax_label']->value==1)||!isset($_smarty_tpl->tpl_vars['display_tax_label']->value))) {?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?> <?php } else { ?> <?php }?><?php }?><meta itemprop="priceCurrency" content="<?php echo $_smarty_tpl->tpl_vars['currency']->value->iso_code;?>
...
<?php }?></span><?php if ($_smarty_tpl->tpl_vars['tax_enabled']->value&&$_smarty_tpl->tpl_vars['display_tax_label']->value==1) {?> <?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value==1) {?><?php } else { ?><?php }?><?php }?></span><?php }?></p>
...
<?php }?>
					...
					<?php }?>
				</div><!-- mgd-details-product -->
			</div> <!-- end mgd-product-essential-->
...
<?php }?>
			...
			<!--Guides des tailles-->
			<!--casques-->
			<?php if ($_smarty_tpl->tpl_vars['category']->value->id==191||$_smarty_tpl->tpl_vars['category']->value->id==203||$_smarty_tpl->tpl_vars['category']->value->id==192||$_smarty_tpl->tpl_vars['category']->value->id==197||$_smarty_tpl->tpl_vars['category']->value->id==198||$_smarty_tpl->tpl_vars['category']->value->id==200||$_smarty_tpl->tpl_vars['category']->value->id==201||$_smarty_tpl->tpl_vars['category']->value->id==244||$_smarty_tpl->tpl_vars['category']->value->id==282||$_smarty_tpl->tpl_vars['category']->value->id==202||$_smarty_tpl->tpl_vars['category']->value->id==294) {?>
			<div class="guide-buttons">
				<?php if ($_smarty_tpl->tpl_vars['lang_iso']->value=='de') {?>
					<a class="guide-tailles" href="https://www.motogoodeal.ch/de/content/31-groessentabelle" title="WIE WÄHLT MAN DEN RICHTIGEN HELM"><span><i class="mgdIcon icon-mannequin2"></i> Grössentabelle Helm</span> </a>
					<a class="guide-tailles" href="https://www.motogoodeal.ch/de/content/27-wie-wahlt-man-den-richtigen-helm" title="Grössentabelle"><span><i class="mgdIcon icon-casque_integral"></i> Den richtigen Helm ?</span></a>
				<?php } else { ?>
				<a class="guide-tailles" href="https://www.motogoodeal.ch/fr/content/31-guide-des-tailles-casque" title="Guide des tailles casques"><span><i class="mgdIcon icon-mannequin2"></i> Guide des tailles casques</span></a>
				<a class="guide-tailles" href="https://www.motogoodeal.ch/fr/content/27-comment-bien-choisir-son-casque" title="Comment choisir son casque"><span><i class="mgdIcon icon-casque_integral"></i>Comment choisir son casque</span></a>
				<?php }?>
			</div>
			<!--gants-->
			<?php } elseif ($_smarty_tpl->tpl_vars['category']->value->id==216||$_smarty_tpl->tpl_vars['category']->value->id==226||$_smarty_tpl->tpl_vars['category']->value->id==218||$_smarty_tpl->tpl_vars['category']->value->id==217||$_smarty_tpl->tpl_vars['category']->value->id==223||$_smarty_tpl->tpl_vars['category']->value->id==224||$_smarty_tpl->tpl_vars['category']->value->id==296||$_smarty_tpl->tpl_vars['category']->value->id==225) {?>
			<div class="guide-buttons">
				<?php if ($_smarty_tpl->tpl_vars['lang_iso']->value=='de') {?>
					<a class="guide-tailles" href="https://www.motogoodeal.ch/de/content/19-grossentabelle-handschuhe" title="Grössentabelle Handschuhe"><span><i class="mgdIcon icon-mannequin2"></i> Grössentabelle Handschuhe</span> </a>
				<?php } else { ?>
					<a class="guide-tailles" href="https://www.motogoodeal.ch/fr/content/19-guide-des-tailles-gants" title="Guide des tailles gants"><span><i class="mgdIcon icon-mannequin2"></i> Guide des tailles gants</span></a>
				<?php }?>
			</div>
			<!--vestes-->
			<?php } elseif ($_smarty_tpl->tpl_vars['category']->value->id==194||$_smarty_tpl->tpl_vars['category']->value->id==195||$_smarty_tpl->tpl_vars['category']->value->id==196) {?>
				<div class="guide-buttons">
					<?php if ($_smarty_tpl->tpl_vars['lang_iso']->value=='de') {?>
						<a class="guide-tailles" href="https://www.motogoodeal.ch/de/content/26-motorradjacken-und-bousons-grossentabelle" title="Grössentabelle Handschuhe"><span><i class="mgdIcon icon-mannequin2"></i> Grössentabelle Motorradjacke</span> </a>
					<?php } else { ?>
						<a class="guide-tailles" href="https://www.motogoodeal.ch/fr/content/26-guide-des-tailles-blousons-moto-et-vestes-moto-homme" title="Guide des tailles gants"><span><i class="mgdIcon icon-mannequin2"></i> Guide des tailles vestes</span></a>
					<?php }?>
				</div>
			<?php } else { ?>
		...
		<div id="more_info_block" class="clearfix">
			...
			<div id="more_info_sheets">
				...
				<?php if (isset($_smarty_tpl->tpl_vars['features']->value)&&$_smarty_tpl->tpl_vars['features']->value) {?>
					<!-- product features -->
					<div id="idTab2">
						<table width="100%" class="table table-striped table technique">
...
?>
							...
							<?php if (($_smarty_tpl->tpl_vars['accessory']->value['allow_oosp']||$_smarty_tpl->tpl_vars['accessory']->value['quantity_all_versions']>0||$_smarty_tpl->tpl_vars['accessory']->value['quantity']>0)&&$_smarty_tpl->tpl_vars['accessory']->value['available_for_order']&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)) {?>
								...
								<li class="ajax_block_product product_accessories_description col-xs-12 col-sm-4 col-md-3">
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['accessory']->value['name'], ENT_QUOTES, 'UTF-8', true),30,'...');?>
</a>
									</p>
