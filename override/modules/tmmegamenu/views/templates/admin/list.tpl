...
<div class="panel tmmegamenu-link">
	<h3>
        {l s='Upload New Search List' mod='tmmegamenu'}
    </h3>
...
<input type="hidden" name="method" value="uploadcsv"> 
  <button type="submit" class="btn btn-primary">Upload</button>
</form>
   
    {if isset($smarty.get.csvUploadMessage) } 
    {if $smarty.get.csvUploadMessage == "Success"}
    <div class="alert alert-success">{$smarty.get.csvUploadMessage}</div>
    {else}
    <div class="alert alert-danger">{$smarty.get.csvUploadMessage}</div>
    {/if} 
    {/if} 
