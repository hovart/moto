...
require_once 'Customweb/PostFinance/BackendOperation/Adapter/RefundParameterBuilder.php';
 ...
 *
 */
class Customweb_PostFinance_BackendOperation_Adapter_RefundAdapter extends Customweb_PostFinance_AbstractAdapter 
	...
	public function partialRefund(Customweb_Payment_Authorization_ITransaction $transaction, $items, $close){
		...
		$builder = new Customweb_PostFinance_BackendOperation_Adapter_RefundParameterBuilder($transaction, $this->getContainer(), $amount, $close);
