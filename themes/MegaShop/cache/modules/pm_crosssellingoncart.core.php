...
class PM_CrossSellingOnCartModule extends Module {
	...
	function displayShareConfig($share_base_config_url) {
		...
		if (file_exists('/home/ddauteuil/www/mgd/modules/pm_crosssellingoncart' . '/css/admin.css'))
			$this->_html .= '<link type="text/css" rel="stylesheet" href="' . $this->_path . 'css/admin.css" />';

		if (file_exists('/home/ddauteuil/www/mgd/modules/pm_crosssellingoncart' . '/js/admin.js'))
	...
	protected function _saveAdvancedStyles($content = false) {
		...
		foreach ($contextShops as $id_shop) {
			$dynamic_css_file = str_replace('.css','-'.$id_shop.'.css','/home/ddauteuil/www/mgd/modules/pm_crosssellingoncart' . '/' . self::DYNAMIC_CSS);
	...
	public function displayAdvancedStyles() {
		if (!is_writable('/home/ddauteuil/www/mgd/modules/pm_crosssellingoncart' . '/css') || !is_dir('/home/ddauteuil/www/mgd/modules/pm_crosssellingoncart' . '/css')) {
