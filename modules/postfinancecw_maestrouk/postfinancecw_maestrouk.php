...
/**
 * PostFinanceCw_MaestroUK 
 * 
 * This class defines is the module class for the 
 * payment method "MaestroUK".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_MaestroUK extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_maestrouk';
	public $paymentMethodName = 'maestrouk';
	public $paymentMethodDisplayName = 'Maestro UK';
