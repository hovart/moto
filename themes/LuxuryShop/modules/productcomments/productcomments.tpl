						...
						<ul>
							...
							{if $is_logged}
								...
								<li>
									...
									<button class="usefulness_btn std-btn" data-is-usefull="1" data-id-product-comment="{$comment.id_product_comment}">
										{l s='yes' mod='productcomments'}
									</button>
									<button class="usefulness_btn std-btn" data-is-usefull="0" data-id-product-comment="{$comment.id_product_comment}">
