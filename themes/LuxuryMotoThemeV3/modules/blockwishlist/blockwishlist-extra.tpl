...
<p class="buttons_bottom_block no-print">
	<a id="wishlist_button_nopop" href="#" onclick="WishlistCart('wishlist_block_list', 'add', '{$id_product|intval}', $('#idCombination').val(), document.getElementById('quantity_wanted').value); return false;" rel="nofollow" title="{l s='Add to wishlist' mod='blockwishlist'}">
		<i class="fa fa-heart left"></i>{l s='Add to wishlist' mod='blockwishlist'}
	</a>
</p>
{else}
	{foreach name=wl from=$wishlists item=wishlist}
		...
		<p class="buttons_bottom_block">
			<a id="wishlist_button" class="button" tabindex="0" data-toggle="popover" data-trigger="focus" title="Wishlist" data-placement="bottom">{l s='Add to wishlist' mod='blockwishlist'}</a></p>
