			...
			<h3>
				<span id="current_obj" style="font-weight: normal;"> 
					<span class="breadcrumb item-0 ">
						{lcw s='PostFinance Transactions' mod='postfinancecw'}
						<img alt=">" style="margin-right:5px" src="../img/admin/separator_breadcrumb.png">
					</span>
					<span class="breadcrumb item-2 ">{lcw s='View' mod='postfinancecw'}</span>
				</span>
			</h3>
		</div>
	</div>
...
<table class="table table-striped table-condensed table-hover table-bordered">
	...
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Transaction ID'}</th>
		<td>{$transaction->getTransactionId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Transaction Number'}</th>
		<td>{$transaction->getTransactionExternalId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Authorization Status'}</th>
		<td>{$transaction->getAuthorizationStatus()}</td>
	</tr>
	{if !empty({$transaction->getOrderId()})}
		<tr>
			<th class="col-lg-3">{lcw  mod='postfinancecw' s='Order ID'}</th>
			<td>{$transaction->getOrderId()}
				<a href="{$link->getAdminLink('AdminOrders')|escape:'htmlall':'UTF-8'}&id_order={$transaction->getOrderId()}&vieworder" class="button">{lcw s='View' mod='postfinancecw'}</a>
			
			</td>
		</tr>
	{/if}
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Created On'}</th>
		<td>{$transaction->getCreatedOn()->format("Y-m-d H:i:s")}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Updated On'}</th>
		<td>{$transaction->getUpdatedOn()->format("Y-m-d H:i:s")}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Customer ID'}</th>
		<td>{$transaction->getCustomerId()}</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Payment ID'}</th>
...
<h3>{lcw  mod='postfinancecw' s='Captures for this transaction'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='postfinancecw' s='Date'}</th>
			<th>{lcw  mod='postfinancecw' s='Amount'}</th>
			<th>{lcw  mod='postfinancecw' s='Status'}</th>
			<th> </th>
		</tr>
	</thead>
	<tbody>
...
<h3>{lcw  mod='postfinancecw' s='Refunds for this transaction'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='postfinancecw' s='Date'}</th>
...
<h3>{lcw  mod='postfinancecw' s='Transactions History'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='postfinancecw' s='Date'}</th>
			<th>{lcw  mod='postfinancecw' s='Action'}</th>
			<th>{lcw  mod='postfinancecw' s='Message'}</th>
		</tr>
	</thead>
	<tbody>
...
{if is_object($transactionObject)}
<h3>{lcw  mod='postfinancecw' s='Customer Data'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	...
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Billing Address'}</th>
		<td>
			...
			{if $context->getBillingDateOfBirth() !== null}
				{lcw  mod='postfinancecw' s='Birthday'}: {$context->getBillingDateOfBirth()->format("Y-m-d")}<br />
			{/if}
			{if $context->getBillingPhoneNumber() !== null}
				{lcw  mod='postfinancecw' s='Phone'}: {$context->getBillingPhoneNumber()|escape:'htmlall'}<br />
			{/if}
		</td>
	</tr>
	<tr>
		<th class="col-lg-3">{lcw  mod='postfinancecw' s='Shipping Address'}</th>
		<td>
			...
			{if $context->getShippingDateOfBirth() !== null}
				{lcw  mod='postfinancecw' s='Birthday'}: {$context->getShippingDateOfBirth()->format("Y-m-d")}<br />
			{/if}
			{if $context->getShippingPhoneNumber() !== null}
				{lcw  mod='postfinancecw' s='Phone'}: {$context->getShippingPhoneNumber()|escape:'htmlall'}<br />
			{/if}
		</td>
	</tr>
</table>
<br />
<h3>{lcw  mod='postfinancecw' s='Products'}</h3>
<table class="table table-striped table-condensed table-hover table-bordered">
	<thead>
		<tr>
			<th>{lcw  mod='postfinancecw' s='Name'}</th>
			<th>{lcw  mod='postfinancecw' s='SKU'}</th>
			<th>{lcw  mod='postfinancecw' s='Quantity'}</th>
			<th>{lcw  mod='postfinancecw' s='Type'}</th>
			<th>{lcw  mod='postfinancecw' s='Tax Rate'}</th>
			<th>{lcw  mod='postfinancecw' s='Amount (excl. VAT)'}</th>
			<th>{lcw  mod='postfinancecw' s='Amount (inkl. VAT)'}</th>
		</tr>
	</thead>
	<tbody>
