<div id="opc_new_account" class="opc-main-block">
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="box">
		<fieldset>
			<h3 class="subheading">{l s='Already registered?'}</h3>
			...
			<div id="login_form_content">
				...
				<p class="submit">
                    ...
                    <button type="submit" id="SubmitLogin" name="SubmitLogin" class="button button-medium"><i class="fa fa-lock left"></i>{l s='Sign in'}</button>
				</p>
			</div>
		</fieldset>
	</form>
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="new_account_form" class="std box" autocomplete="on" autofill="on">
		<fieldset>
			
	            <h3 id="new_account_title" class="subheading">{l s='New Customer'}</h3>
	            <div id="opc_account_choice" class="row">
                    <div class="col-xs-12 col-sm-6">
	                    <p class="title_block">{l s='Instant Checkout'}</p>
	                    <p class="opc-button">
	                        <button type="submit" class="button button-medium exclusive" id="opc_guestCheckout">{l s='Guest checkout'}</button>
	                    </p>
	                </div>
	                <div class="col-xs-12 col-sm-6">
	                    ...
	                    <p class="opc-button">
	                        <button type="submit" class="button button-medium exclusive" id="opc_createAccount"><i class="fa fa-user left"></i>{l s='Create an account'}</button>
	                    </p>
	                </div>
	            </div>
				<div id="opc_account_form" class="unvisible">
					...
					{/if}
					<h3 class="subheading top-indent">{l s='Delivery address'}</h3>
					{$stateExist = false}
					{$postCodeExist = false}
					{$dniExist = false}
					...
					<div class="submit opc-add-save clearfix">
		                ...
		                <button type="submit" name="submitAccount" id="submitAccount" class="button">{l s='Save'}</button>
