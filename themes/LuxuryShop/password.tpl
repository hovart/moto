...
<form action="{$request_uri|escape:'html':'UTF-8'}" method="post" class="std" id="form_forgotpassword">
	<fieldset>
		...
		<p class="submit">
            <button type="submit" class="button">{l s='Retrieve Password'}<i class="fa fa-chevron-right right"></i></button>
		</p>
	</fieldset>
</form>
</div>
...
<ul class="clearfix footer_links">
	<li><a class="button std-btn" href="{$link->getPageLink('authentication')|escape:'html':'UTF-8'}" title="{l s='Back to Login'}" rel="nofollow"><i class="fa fa-chevron-left left"></i>{l s='Back to Login'}</a></li>
</ul>
