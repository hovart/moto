...
<div class="paiement_block">
    ...
    {if $HOOK_PAYMENT}
        {if !$opc}
            <div id="order-detail-content" class="table_block table-responsive clearfix">
                ...
                {if $use_taxes}
                    ...
                    {/if}
                    <tr class="cart_total_price">
                        <td class="total_price_container"><span>{l s='Total'}</span></td>
    ...
    <p class="cart_navigation clearfix">
        <a href="{$link->getPageLink('order', true, NULL, "step=2")|escape:'html':'UTF-8'}" title="{l s='Previous'}" class="button std-btn">
