 ...
 */
class Customweb_PostFinance_Method_Invoice_Abstract extends Customweb_PostFinance_Method_DefaultMethod {
	 ...
	 * @return DateTime
	 */
	protected function getBirthdate(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
	...
	protected function getCustomerGender(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
	...
	protected function getSalutation(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
		$salutation = $orderContext->getBillingSalutation();
		if (!empty($salutation)) {
	...
	protected function getBillingCivilityParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		return array(
			'CIVILITY' => Customweb_Util_String::substrUtf8($this->getSalutation($transaction, $formData), 0, 10) 
		);
	}

	protected function getSalesTaxNumber(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
	...
	protected function getSalesTaxNumberParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
	...
	protected function getPhoneNumber(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
	...
	protected function getOwnerPhoneNumberParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		return array(
			'OWNERTELNO' => Customweb_Util_String::substrUtf8($this->getPhoneNumber($transaction, $formData), 0, 30) 
		);
	}

	protected function getCustomerReferenceIdParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
	...
	protected function getCommericalRegisterNumber(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
	...
	protected function getSocialSecurityNumber(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData){
		$orderContext = $transaction->getTransactionContext()->getOrderContext();
