 ...
 *
 * Usage: $jqPm.tmpl('<div class="#{classname}">#{content}</div>', { 'classname' : 'my-class', 'content' : 'My content.' });
 *        $jqPm.tmpl('<div class="#{1}">#{0}</div>', 'My content', 'my-class');   // placeholder order not important
 *
