	...
	<div class="primary_block">
		...
		<div class="pb-left-column">
			...
			<div id="image-block">
				...
				{if $product->on_sale || ($product->specificPrice && $product->specificPrice.reduction && $productPriceWithoutReduction > $productPrice)}<span class="sale-box">{l s='Sale!'}</span>{/if}
				{if $have_image}
		...
		<div class="pb-right-column">
			...
			<p id="product_manufacturer" class="product_p">
				<label class="attribute_label">{l s='Brands'} :</label>
				<a href="{$link->getmanufacturerLink($product->id_manufacturer, $product->link_rewrite)|escape:'html':'UTF-8'}" title="{$product->manufacturer_name|escape:'html':'UTF-8'}">{$product->manufacturer_name|escape:'html':'UTF-8'}</a>
			</p>
			{/if}
