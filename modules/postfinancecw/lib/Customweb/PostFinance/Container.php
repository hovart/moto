 ...
 *
 */
class Customweb_PostFinance_Container extends Customweb_Payment_AbstractContainer {
	...
	public function getConfiguration(){
		return $this->getBean('Customweb_PostFinance_Configuration');
	}
	...
	public function getMethodFactory(){
		return $this->getBean('Customweb_PostFinance_Method_Factory');
	}
	 ...
	 * @return Customweb_PostFinance_Method_IMethod
	 */
