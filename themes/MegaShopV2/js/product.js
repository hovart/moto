...
function updateDisplay()
{
	...
	if (!selectedCombination['unavailable'] && quantityAvailable > 0 && productAvailableForOrder == 1)
	{
		...
		console.log('availableNowValue : ' + availableNowValue);
	...
	else
	{
		...
		console.log('availableLaterValue : ' + availableLaterValue);
		$('#availability_value').text(availableLaterValue).addClass('warning_inline');
		/***** OVERRIDE BY DETAILS.CH ******/
