 ...
 * payment method "PostFinanceEFinance".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_PostFinanceEFinance extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_postfinanceefinance';
	public $paymentMethodName = 'postfinanceefinance';
	public $paymentMethodDisplayName = 'PostFinance E-Finance';
