...
{/if}
    ...
    <script type="text/javascript" src="https://fast.fonts.net/jsapi/2b0f1663-d940-41ae-97af-b18faea44550.js"></script>
{if isset($js_files)}
	...
	{if !$content_only}
		...
		<div id="page">
			...
			<div id="columns" class="row clearfix">
				{if $page_name != 'index' && $page_name != 'product' && $page_name != 'damienudry'}
