...
{capture name=path}{l s='Your addresses'}{/capture}
	...
	<form action="{$link->getPageLink('address', true)|escape:'html':'UTF-8'}" method="post" class="std box" id="add_address">
...
<ul class="footer_links clearfix">
	<li>
		<a class="button std-btn" href="{$link->getPageLink('addresses', true)|escape:'html':'UTF-8'}">
			<i class="fa fa-chevron-left left"></i> {l s='Back to your addresses'}
		</a>
	</li>
</ul>
{strip}
