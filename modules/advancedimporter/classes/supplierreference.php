...
class AdvancedImporterSupplierReference
{
    public $id_product;
    ...
    public function __construct($reference)
    {
        ...
        $res = self::getProductIdBySupplierReference($reference);
     ...
     * @return array
     */
    public static function getProductIdBySupplierReference($reference)
    {
        $query = new DbQuery();
        $query->select('c.id_product, c.id_product_attribute');
        $query->from('product_attribute', 'c');
        $query->where('c.supplier_reference = \''.pSQL($reference).'\'');
        ...
        $query->where('p.supplier_reference = \''.pSQL($reference).'\'');
