...
<table style="width: 100%; font-size: 13pt; color: #000;">
	<tr>
		<td style="width: 48%;"><span style="font-weight: bold;">{l s='Billing Address' pdf='true'}
	...
	<tr>
		<td style="height: 105px;"><br /><br />{$invoice_address}<br />
			{$invoice_phone_mobile}<br />
			{$invoice_phone}
		</td>
		<td>&nbsp;</td>
	...
	<table style="width: 100%; text-align: center; border: 1px solid #CCC; font-size: 9pt;">
		...
		<tr>
			...
			<td style="width: 33%;">
				...
				{if $shipping.id_carrier == 46 || $shipping.id_carrier == 44 || $shipping.id_carrier == 54 || $shipping.id_carrier == 56}
					<strong><span style="color:#f02a00">{$shipping.state_name}</span></strong>
					{else}
					{$shipping.state_name}
				{/if}
	...
	<tr style="line-height:6px;background-color:{$bgcolor};">
		...
		<td style="text-align: center;">
			{if $order_detail.product_quantity > 1 }
				<strong><span style=" color:#f02a00"> {$order_detail.product_quantity}</span></strong>
			{else}
...
<table style="width: 100% ; font-size:13pt; font-weight: bold">
	<tr>
		<td style="width: 100%  ; height : 25px;">{l s='In case of return' pdf='true'}</td>
	</tr>
</table>

	<p style="font-size: 13pt; color: #000;"><strong>Customer ID - Name:</strong><br>
		{$customer->id} - {$customer->lastname} {$customer->firstname}</p>
</div>