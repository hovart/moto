...
/**
 * PostFinanceCw_KbcOnline 
 * 
 * This class defines is the module class for the 
 * payment method "KbcOnline".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_KbcOnline extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_kbconline';
	public $paymentMethodName = 'kbconline';
	public $paymentMethodDisplayName = 'KBC Online';
