...
<div id="mywishlist">
	...
	{if $id_customer|intval neq 0}
		<form method="post" class="std box" id="form_wishlist">
			<fieldset>
				<h3 class="subheading">{l s='New wishlist' mod='blockwishlist'}</h3>
	...
	<ul class="footer_links clearfix">
		<li>
			<a class="button std-btn" href="{$link->getPageLink('my-account', true)|escape:'html':'UTF-8'}">
				<i class="fa fa-chevron-left left"></i>{l s='Back to Your Account' mod='blockwishlist'}
			</a>
		</li>
		<li>
			<a class="button std-btn" href="{$base_dir|escape:'html':'UTF-8'}">
				<i class="fa fa-chevron-left left"></i>{l s='Home' mod='blockwishlist'}
			</a>
		</li>
	</ul>
</div>
