...
<div class="media">
        <a href="{$ps_url|escape:'htmlall':'UTF-8'}modules/flashsalepro/doc/flash_doc_{$default_language_iso_code|escape:'htmlall':'UTF-8'}.pdf" target="_blank">
            <img src="{$ps_url|escape:'htmlall':'UTF-8'}modules/flashsalepro/views/img/pdf.png">{l s='Premium Flash Sale Documentation' mod='mailchimp'}
        </a>
