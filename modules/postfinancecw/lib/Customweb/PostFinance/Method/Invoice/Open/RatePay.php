...
require_once 'Customweb/PostFinance/Method/Invoice/Open/Abstract.php';
require_once 'Customweb/PostFinance/Util.php';
require_once 'Customweb/PostFinance/Method/Invoice/LineItemBuilder/RatePay.php';
 ...
 */
class Customweb_PostFinance_Method_Invoice_Open_RatePay extends Customweb_PostFinance_Method_Invoice_Open_Abstract {
	...
	public function getAuthorizationParameters(Customweb_PostFinance_Authorization_Transaction $transaction, array $formData, $authorizationMethod) {
		...
		$builder = new Customweb_PostFinance_Method_Invoice_LineItemBuilder_RatePay($transaction->getTransactionContext()->getOrderContext());
	...
	protected function getBillingAddressParameters(Customweb_PostFinance_Authorization_Transaction $transaction) {
		...
		$parameters['ECOM_BILLTO_POSTAL_NAME_FIRST'] = Customweb_PostFinance_Util::substrUtf8($orderContext->getBillingFirstName(), 0, 35);
		$parameters['ECOM_BILLTO_POSTAL_NAME_LAST'] = Customweb_PostFinance_Util::substrUtf8($orderContext->getBillingLastName(), 0, 35);
