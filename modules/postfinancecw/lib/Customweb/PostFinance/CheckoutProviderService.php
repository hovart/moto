...
require_once 'Customweb/PostFinance/MasterPass/Checkout.php';
 ...
 *
 */
class Customweb_PostFinance_CheckoutService implements Customweb_Payment_ExternalCheckout_IProviderService {
	...
	public function __construct(Customweb_DependencyInjection_IContainer $container) {
		$this->masterPassCheckout = new Customweb_PostFinance_MasterPass_Checkout();
