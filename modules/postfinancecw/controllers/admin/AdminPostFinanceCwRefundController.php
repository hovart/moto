 ...
 *         			 		  	    
 */
class AdminPostFinanceCwRefundController extends AdminController
{
	public function __construct() {
		$this->className = 'AdminPostFinanceCwRefundController';
		parent::__construct();
		$this->context->smarty->addTemplateDir($this->getTemplatePath());
		$this->tpl_folder = 'postfinancecw_refund/';
		$this->bootstrap = true;
	}
	...
	public function initContent()
	{
		...
		$data = $_GET;
		$transaction = current(PostFinanceCw_Entity_Transaction::getTransactionsByOrderId((int)$data['id_order']));
		...
		$vars['refundAmount'] = PostFinanceCw::getRefundAmount($data);
