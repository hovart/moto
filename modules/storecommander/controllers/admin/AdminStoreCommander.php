        ...
        if (Tools::getIsset("SETLOGUSER")) {
            ...
            if (version_compare(_PS_VERSION_, '1.5.0.0', '>=')) {
                ...
                if ($id_shop == 0 && Shop::getTotalShops() > 1) {
                    $_html .= ('<div class="error"><p>&nbsp;There is a problem with the shop ID</p></div>');
                } else {
            ...
            $_html .= '<fieldset><legend>Store Commander</legend>
            ...
            if ($scdir === false) {
                $_html .= ('<div class="error"><p>&nbsp;Unable to find the Store Commander folder. Please contact <a href="support.storecommander.com" targe="_blank">support.storecommander.com</a></p></div>');
            } else {
                $_html .= '<fieldset><legend>Store Commander</legend>
						<label>Loading...</label>
						<div class="margin-form">
