...
class Customweb_PostFinance_ExternalCheckout_MasterPass_AddressRequestParameterBuilder extends Customweb_PostFinance_ExternalCheckout_MasterPass_AbstractRequestParameterBuilder{
	
	private $data;
	
	public function __construct(Customweb_Payment_ExternalCheckout_IContext $context, Customweb_PostFinance_Container $container, $data) {
