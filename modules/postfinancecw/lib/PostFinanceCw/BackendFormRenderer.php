...
require_once 'PostFinanceCw/ConfigurationAdapter.php';


class PostFinanceCw_BackendFormRenderer extends Customweb_Form_Renderer
{

	private $configurationAdapter = null;
	
	public function __construct() {
		$this->configurationAdapter = new PostFinanceCw_ConfigurationAdapter();
		$this->setCssClassPrefix('postfinancecw-');
	}
