 ...
 *
 */
class PostFinanceCw_Adapter_PaymentPageAdapter extends PostFinanceCw_Adapter_AbstractAdapter {
	...
	protected function preparePaymentFormPane() {
		...
		if ($this->visibleFormFields !== null && count($this->visibleFormFields) > 0) {
			...
			$this->formActionUrl = $link->getModuleLink('postfinancecw', 'redirection', $parameters, true);
		}
		else {
			if ($this->getTransaction() !== null) {
