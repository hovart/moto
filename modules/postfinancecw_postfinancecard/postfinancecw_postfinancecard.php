 ...
 * payment method "PostFinanceCard".
 * 
 * @author customweb GmbH
 */
class PostFinanceCw_PostFinanceCard extends PostFinanceCw_PaymentMethod
{
	public $name = 'postfinancecw_postfinancecard';
	public $paymentMethodName = 'postfinancecard';
	public $paymentMethodDisplayName = 'PostFinance Card';
